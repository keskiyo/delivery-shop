/**
 * Секция "Специальные предложения" (баннер акций)
 * 
 * Отображает большой баннер с акциями на главной странице:
 * - Изображение: /images/banners/banner-action-desk.jpeg
 * - Заголовок: "Специальные предложения"
 * 
 * Адаптивность:
 * - Мобильная версия: полная ширина
 * - Десктоп: фиксированная ширина (584px -> w-88.25, 800px -> w-146)
 * 
 * Используется на:
