...
const NewProducts = async () => {
	...
	try {
		const res = await fetch(
			`${process.env.NEXT_PUBLIC_BASE_URL!}/api/products?categories=new`,
		)
		...
		console.error('Ошибка получения новых продуктов', err)
	}
		...
		<section className='pb-8 md:pb-16 xl:pb-20'>
			<Container>
				<div className='mb-4 md:mb-8 xl:mb-10 flex flex-row justify-between'>
					...
					<ViewAllLink href='new' btnText='Все новинки' />
				</div>
