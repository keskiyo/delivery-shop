 ...
 * - Подсветка совпадающего текста (HighlightText)
 * - Клик по категории -> переход на страницу категории
 * - Клик по товару -> переход на страницу товара
 * - После клика сбрасывает поиск (resetSearch)
 * 
 * Состояния:
 * - isLoading: показывает Loader
 * - Есть результаты: показывает список категорий и товаров
 * - Нет результатов (query > 2): "Ничего не нашлось"
 * - query < 3: "Введите 3 или более символов для поиска"
 * 
 * Использует:
 * - TRANSLATIONS для перевода названий категорий на русский
 * - HighlightText для подсветки найденных совпадений
 * 
 * Используется в:
 * - InputBlock.tsx
 */
