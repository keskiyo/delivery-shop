 ...
 * 
 * Функционал:
 * - Отображает 5 звезд с частичным заполнением
 * - Поддерживает дробные значения рейтинга (например, 4.5)
 * - Пустые звезды используют `--border`, заполненные используют `--promo`
 * 
 * @param rating - Значение рейтинга от 0 до 5 (по умолчанию 5.0)
 * 
 * @example
 * <StarRating rating={4.5} /> // 4 полные звезды + 1 наполовину заполненная
 * <StarRating rating={3.2} /> // 3 полные звезды + 1 на 20% заполненная
 */
