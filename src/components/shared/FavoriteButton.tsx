 ...
 * 
 * Функционал:
 * - Проверяет авторизацию пользователя (если не авторизован - редирект на /login)
 * - Переключает состояние избранного (добавить/удалить)
 * - Визуально отображает активное состояние (заполненное сердце)
 ...
 *   - 'default': Круглая кнопка с фоном (для карточек товаров)
 *   - 'onProductPage': Кнопка с текстом "В избранное" (для страницы товара)
 */
