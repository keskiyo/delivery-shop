...
// Назначение: расчет стоимости корзины со скидками, картой лояльности и бонусами.
// Как работает: Агрегирует позиции корзины, ограничивает списание бонусов и синхронизирует итоги с cartStore.
