 ...
 *
 * Функционал:
 * - Вход по email или телефону (переключение между режимами)
 * - Проверка существования и верификации пользователя
 * - Для телефона: выбор метода аутентификации (пароль или OTP)
 * - Для email: переход к вводу пароля
 * - Обработка неверифицированных email
 * - Ссылки на регистрацию и восстановление пароля
 *
 * Логика:
 * 1. Пользователь вводит email или телефон
 * 2. Система проверяет существование и верификацию
 * 3. Для телефона: предлагает выбрать метод входа (пароль/OTP)
 * 4. Для email: переходит к вводу пароля
 *
 * @route /login
 */
