...
export default function FloatingMenuButton({
	...
	return (
		<button
			onClick={onClick}
			className='group fixed bottom-6 right-6 z-40 flex h-14 w-14 cursor-pointer items-center justify-center rounded-full bg-brand text-white shadow-(--shadow-button-default) transition-custom hover:scale-105 hover:bg-brand-hover active:scale-95'
