...
const OrderSuccessMessage = ({
	...
	return (
		<div className='text-center p-4 bg-success-soft text-success rounded border border-success'>
			...
			{useBonuses && (
				<div className='text-sm mb-3 text-success flex items-center justify-center gap-2'>
			...
			<button
				...
				className='ml-4 px-4 py-2 bg-brand hover:bg-brand-hover rounded text-white cursor-pointer transition-custom'
			>
