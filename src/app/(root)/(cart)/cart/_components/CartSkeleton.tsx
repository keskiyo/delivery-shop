const CartSkeletons = () => {
	return (
		<div className='bg-card rounded flex shadow-cart-item animate-pulse'>
			<div className='w-6 h-6 bg-muted rounded absolute -top-3 left-4'></div>

			<div className='flex flex-row flex-wrap md:flex-row justify-between w-full md:flex-nowrap'>
				<div className='flex flex-row flex-wrap md:flex-nowrap'>
					<div className='w-24 h-24 bg-muted rounded m-2'></div>
				...
				<div className='flex flex-wrap justify-between items-center gap-2 w-full p-2 md:flex-nowrap md:flex-col md:justify-normal md:items-end xl:flex-row xl:items-start xl:justify-end'>
					<div className='flex items-center gap-2 w-32 h-10 bg-muted p-2 rounded-lg'>
						<div className='w-8 h-8 bg-surface-hover rounded'></div>
						<div className='w-16 h-6 bg-surface-hover rounded'></div>
						<div className='w-8 h-8 bg-surface-hover rounded'></div>
					</div>

					<div className='w-26 h-8 bg-muted rounded'></div>
				</div>
			</div>
		</div>
	)
