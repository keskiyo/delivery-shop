			...
			<div className='bg-card rounded p-6 max-w-sm w-full'>
				...
				<div className='flex gap-3 w-full'>
					<button
						...
						onClick={onConfirm}
						className='flex-1 bg-brand text-white py-2 rounded hover:shadow-button-default transition-custom disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer'
					>
					...
					<button
						onClick={onCancel}
						disabled={isUploading}
						className='flex-1 bg-site-chrome rounded hover:shadow-button-secondary py-2 active:shadow-button-active disabled:opacity-50 text-white transition-custom cursor-pointer'
					>
						Отмена
					</button>
				</div>
