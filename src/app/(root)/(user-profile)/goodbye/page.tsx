	...
	return (
		<AuthFormLayout>
			<div className='bg-card flex flex-col justify-center items-center'>
				...
				<Link
					href='/'
					className='bg-brand hover:shadow-(--shadow-button-default) active:shadow-(--shadow-button-active) w-full text-center text-white text-2xl px-3 py-2 cursor-pointer rounded duration-300'
				>
					На главную
				</Link>
			</div>
