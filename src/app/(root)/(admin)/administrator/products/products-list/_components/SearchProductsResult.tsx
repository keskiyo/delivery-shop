			...
			<div className='flex justify-between items-center mb-4'>
				...
				{products.length > 0 && (
					<button
						...
						className={`${buttonStyles.active} px-4 py-2 text-sm cursor-pointer hover:shadow-article active:shadow-button-active`}
					>
						Очистить результаты
					</button>
				)}
			...
			<div className='grid gap-4'>
				{products.length === 0 ? (
					...
					products.map(product => (
						<div
							key={product.id}
							className='border border-border rounded p-4 flex justify-between items-center bg-card'
						>
