...
export default function ScheduleTableHeader({
	...
	return (
		<div className='grid grid-cols-4 border-b border-border'>
			<div className='p-2 md:p-3 font-semibold border-r border-border text-xs md:text-sm'>
				Время
			</div>
			{dates.map(date => (
				<div
					key={date}
					className='p-2 md:p-3 font-semibold text-center border-r border-border last:border-r-0'
				>
