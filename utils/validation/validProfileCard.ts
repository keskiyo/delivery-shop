// Назначение: очистка, проверка и форматирование карты лояльности.
// Как работает: Хранит только цифры, проверяет длину 16 и маскирует номер вне режима редактирования.
