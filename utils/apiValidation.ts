// Назначение: общие проверки входных данных для API routes.
// Как работает: Приводит неизвестные значения к безопасным строкам, числам, boolean и массивам без падения на неверных типах.
